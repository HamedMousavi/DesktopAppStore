<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Desktop/Product.Master" Inherits="System.Web.Mvc.ViewPage<DomainModel.Entities.ApplicationProduct>" %>
...
<div id="catalog">
    ...
    <div class="page_title" style="float:<%:UiResources.UiTexts.float_left%>;">
        <%: UiResources.UiTexts.software_specifications %>
    </div>
    ...
    <table width="100%" cellpadding="4px" cellspacing="0px" border="0">
        ...
        <tr>
            <td>
                <div id="screenshot">
                    <%: Html.SoftwareScreenshot(Model, Request.Url.AbsoluteUri.Replace("/Catalog", ""))%>
                </div>
            </td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="RightContent" runat="server">
    ...
    <div id="related_tags">
        <div class="overview_title"><%:UiResources.UiTexts.related_tags%></div>
        <ul>
